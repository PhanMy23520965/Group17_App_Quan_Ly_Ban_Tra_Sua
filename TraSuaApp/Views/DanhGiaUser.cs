...
namespace TraSuaApp.View
{
    public partial class DanhGiaUser : Form
    {
        ...
        public DanhGiaUser(string maDH)
        {
            InitializeComponent();
            MaDH = DBServices.Connect().Collection("DonHang").Document(maDH);
        ...
        private void InitializeStarRating()
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                {
                    ImageSize = new Size(50, 50),   // Kích thước hình ngôi sao
                    Size = new Size(50, 50),        // Kích thước nút
                    Location = new Point(240 + i * 50, 130),  // Vị trí
        ...
        private async void guna2GradientButton2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MaKH = db.Collection("KhachHang").Document(Dangnhap.MaKH),
                    MaDH = MaDH,
